...
class TestSendData(unittest.TestCase):
    def test_01(self):
        ...
        try:
            ...
            raise MissingKeyException('You must run the test with an ' +
                                      'extra argument: Your DeepJewel Key')
    ...
    def test_send(self):
        ...
        the better, currently the max text size is 10MB, which is pretty huge.
        And as you can see, there's no need to do any parsing or anything like that,
